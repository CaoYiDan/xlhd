...
- (void)sw_handleWithValue:(NSString *)value {
    ...
    [param setValue:value forKey:@"merchant_code"];
    
    NSString *jsonStr = [[Singleton shardeManger]convertToJsonData:param];
    [[DataRequest Manager] postBossDemoWithUrl:[NSString stringWithFormat:@"%@user/merchant-bind",base_url] param:jsonStr success:^(NSDictionary *dict) {
