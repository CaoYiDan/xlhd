...
- (void)awakeFromNib {
    [super awakeFromNib];
    [self.view1 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view2 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view3 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view4 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view5 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view6 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view7 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view8 setBorderLineWithColor:RGB(231, 229, 229)];
    [self.view9 setBorderLineWithColor:RGB(231, 229, 229)];
